...
protected:
	...
	// Last rotation saved from the actor
...
public:
	...
	// Tick for different calculations
	virtual void Tick(float DeltaSeconds) override;
	
	// Getter of IsAttacking
	bool GetIsAttacking() const { return bIsAttacking; }
	
	// Yaw delta difference
	float GetYawDelta() const { return DeltaRotation.Yaw; }
	
	// Return speed in horizontal plane
